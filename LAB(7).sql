...
SELECT * FROM STUDENTS
WHERE FIRSTNAME LIKE 'K%' AND FIRSTNAME LIKE '___Y';
...
SELECT STU-ID,CITY FROM STUDENTS
WHERE  DIVISION LIKE '_____' AND WEBSITE IS NOT NULL
--20. Display all the students whose name’s third character is consonant.
SELECT * FROM STUDENTS 
WHERE FIRSTNAME LIKE '___[AEIOU]'